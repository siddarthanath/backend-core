...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_organisations_slug"), "organisations", ["slug"], unique=True
    )
    op.create_index(
        op.f("ix_organisations_stripe_customer_id"),
        "organisations",
        ["stripe_customer_id"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["invited_by"], ["user_profiles.id"], ondelete="SET NULL"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "plan",
            sa.Enum("FREE", "PRO", "MAX", "ENTERPRISE", name="plan"),
            nullable=False,
        ),
        sa.Column(
            "status",
    ...
    op.create_index(
        op.f("ix_subscriptions_org_id"), "subscriptions", ["org_id"], unique=True
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "resource_id", sqlmodel.sql.sqltypes.AutoString(length=200), nullable=True
        ),
        sa.Column("event_metadata", sa.JSON(), nullable=True),
        sa.ForeignKeyConstraint(
            ["actor_id"], ["user_profiles.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["org_id"], ["organisations.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "description", sqlmodel.sql.sqltypes.AutoString(length=300), nullable=True
        ),
        sa.ForeignKeyConstraint(["org_id"], ["organisations.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        op.f("ix_feature_flags_org_id"), "feature_flags", ["org_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["created_by"], ["user_profiles.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["org_id"], ["organisations.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_organisations_stripe_customer_id"), table_name="organisations"
    )
