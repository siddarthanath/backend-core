...
class AuthException(CoreException):
    ...
    def __init__(
        ...
        super().__init__(
            code="AUTH_ERROR", message=message, detail=detail, status_code=401
        )
...
class ForbiddenError(CoreException):
    ...
    def __init__(self, message: str = "Forbidden") -> None:
        super().__init__(
            code="FORBIDDEN", message=message, detail=None, status_code=403
        )
...
class AppValidationError(CoreException):
    ...
    def __init__(
        self, message: str = "Validation error", detail: str | None = None
    ) -> None:
        super().__init__(
            code="VALIDATION_ERROR", message=message, detail=detail, status_code=422
        )
...
class RateLimitError(CoreException):
    ...
    def __init__(
        self, message: str = "Rate limit exceeded", detail: str | None = None
    ) -> None:
        super().__init__(
            code="RATE_LIMIT_ERROR", message=message, detail=detail, status_code=429
        )
